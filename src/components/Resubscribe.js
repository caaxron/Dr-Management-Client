...
import { resubscribe } from "../api/resubscribe";
...
function Resubscribe() {
  ...
  const mutation = useMutation((company) => resubscribe(company), {
    onSuccess: () => {
      navigate("/home");
      toast.success("Resubscribe successfully", {
        position: "top-center",
        autoClose: 1000,
                ...
                <div className="text-white flex justify-center ">
                  <div>
                    <h2 className="p-5 text-2xl">
                      Please enter your your company name and code to
                      resubscribe account!
                    </h2>
                    <h2 className="p-5 text-2xl">
